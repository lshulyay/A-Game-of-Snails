...
ig.global.EntitySnail = ig.Entity.extend({
    ...
    //    this.guiPos = {x: this.pos.x + this.size.x + 10, y: this.pos.y};
    ...
    addToJar: function() {
        ...
        for (var i = length; i > 0; i--) {
            ...
            /*    for (var n = 0; n < jar.occupantsGrid.length; n++) {
                    var spot = jar.occupantsGrid[n];
                    if (!spot.occupied) {
                        spot.occupied = true;
                        this.pos.x = spot.x;
                        this.pos.y = spot.y;
