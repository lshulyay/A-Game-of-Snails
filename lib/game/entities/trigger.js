		...
		if (this.inUse) {
			switch (this.kind) {
				...
				case 'racesButton':
					...
					// ig.game.spawnEntity(EntityRacelistGui,ig.system.width - 200, ig.system.height - 350);
					break;
				case 'createRace':
			...
			switch (this.kind) {
	        	...
	        	case 'raceSlot':
	        		if (!this.temp.slotOccupied) {
			            ...
			            var y = this.pos.y + 3;
			            this.ctx.fillText(this.temp.occupyingSnail.name + ' ' + this.temp.occupyingSnail._id, x, y);
			            y += 35;
...
//			this.parent();
	...
	//	ig.game.test = this.temp.occupyingSnail;
